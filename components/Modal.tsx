     ...
     <ReactPlayer
       ...
       <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
            <div className="flex space-x-2">
              ...
              <button>
                <AiOutlinePlus className='modalButton h-7 w-7' />
              </button>
              <button>
                <FaThumbsUp className= 'hover:scale-150 transition hover:text-blue-500 mx-2' />
              </button>
            </div>
            <button onClick={() => setMuted(!muted)}>
                {muted? <BiVolumeMute className="h-6 w-6"/> : <BsVolumeUp className="h-6 w-6"/>}
            </button>
        </div>
